...
class _ReportUserPageState extends State<ReportUserPage> {
  ...
  String _selectedCategory = 'No-show / Flaked';
  ...
  final Map<String, String> _categoryMapping = {
    'Offline Harassment': 'Harassment',
    'No-show / Flaked': 'No-show',
    'Scam / Fraud': 'Scam',
    'Spamming': 'Spam',
    'Other Misbehavior': 'Other',
  };
  ...
  Future<void> _submitReport() async {
    ...
    try {
      ...
      final body = {
        'violation_type': _categoryMapping[_selectedCategory] ?? 'Other',
        'description': _detailsController.text.trim(),
        'evidence_urls': evidenceUrls,
      };

      await ApiClient().post('/auth/user/${widget.userId}/report', body);

      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('User reported successfully. Moderators will review.')),
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Report User', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, color: Colors.white)),
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'Describe the issue or behavior in detail. Please provide clear facts.',
